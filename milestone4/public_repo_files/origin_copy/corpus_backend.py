...
def insert_table(html_df, no_results = False, search_term = None):
    ...
    if no_results and search_term is not None:
        html = html.replace(' Your search results will appear here. Enter a search term to get started! ', 'Sorry, no results were found for your search: ' + search_term)
    if no_results == False and search_term is not None:
        html = html.replace(' Your search results will appear here. Enter a search term to get started! ', 'You searched for: ' + search_term + '<br><br><br>' + html_df)
    if no_results == False and search_term is None:
        html = html.replace(' Your search results will appear here. Enter a search term to get started! ', 'Here are your results! <br><br><br>' + html_df)
    return html
